    ...
    <div className="min-h-screen bg-[#030305] text-white font-sans relative overflow-hidden selection:bg-fuchsia-500 selection:text-white pb-32">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-8 py-8 sm:py-12 flex flex-col items-center">
        ...
        <div className="w-full mb-12 flex items-center justify-between">
          <Link href={`/${currentLocale}`} className="w-12 h-12 bg-white/5 hover:bg-white/10 border border-white/10 rounded-2xl flex items-center justify-center text-neutral-400 hover:text-white transition-all shadow-lg backdrop-blur-md">
          ...
          <div className="px-5 py-2.5 bg-gradient-to-r from-fuchsia-500/10 to-purple-500/10 border border-fuchsia-500/20 rounded-xl text-[10px] font-black uppercase tracking-widest text-fuchsia-400 flex items-center gap-2 shadow-inner">
            <Smartphone size={14} /> {t.getApp?.officialApp || "Official Ecosystem App"}
          </div>
        </div>
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 animate-[fadeInUp_0.4s_ease-out]">
          ...
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black tracking-tighter mb-6 leading-tight">
            {t.getApp?.takeAcademyEverywhere || "Take the Academy Everywhere."}
          </h1>
          <p className="text-neutral-400 text-sm sm:text-base leading-relaxed max-w-xl mx-auto font-medium">
            {t.getApp?.appSubtitle || "The Safi Academy mobile experience brings your trading journals, live classes, network feed, and secure wallet right to your fingertips. Always synced, always secure."}
          </p>
        </div>
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-20">
          {[
            { icon: <BellRing size={24}/>, title: t.getApp?.instantAlerts || "Instant Alerts", desc: t.getApp?.instantAlertsDesc || "Never miss a market update or live class notification.", color: "text-amber-400", bg: "bg-amber-500/10", border: "border-amber-500/20" },
            { icon: <Video size={24}/>, title: t.getApp?.liveAgoraHd || "Agora RTC Live", desc: t.getApp?.liveAgoraHdDesc || "Interactive zero-latency voice and video lectures.", color: "text-red-400", bg: "bg-red-500/10", border: "border-red-500/20" },
            { icon: <ShieldCheck size={24}/>, title: t.getApp?.biometricSecurity || "Biometric Security", desc: t.getApp?.biometricSecurityDesc || "Encrypted credential storage with FaceID & fingerprint.", color: "text-emerald-400", bg: "bg-emerald-500/10", border: "border-emerald-500/20" },
            { icon: <Zap size={24}/>, title: t.getApp?.offlineJournal || "Offline Journal", desc: t.getApp?.offlineJournalDesc || "Record setups anytime with seamless cloud sync.", color: "text-blue-400", bg: "bg-blue-500/10", border: "border-blue-500/20" },
          ].map((feat, i) => (
        ...
        <div className="w-full max-w-4xl bg-gradient-to-b from-[#0a0a0f]/90 to-[#050508]/90 backdrop-blur-2xl border border-white/10 rounded-[3rem] p-8 sm:p-12 shadow-[0_30px_60px_rgba(0,0,0,0.6)] mb-12">
          <div className="flex items-center gap-4 mb-8 border-b border-white/5 pb-6">
            ...
            <div>
              <h2 className="text-2xl sm:text-3xl font-black text-white tracking-tight">
                {t.getApp?.androidApp || "Android Devices"}
              </h2>
            ...
            >
              ...
              <div className="relative h-full bg-[#08080c] border border-emerald-500/30 group-hover:border-emerald-500/60 rounded-[2.5rem] p-6 sm:p-8 flex flex-col sm:flex-row items-center sm:items-start gap-6 transition-all z-10 text-center sm:text-left">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-neutral-400 text-xs leading-relaxed">Download safely from the Play Store with automatic updates.</p>
                </div>
              </div>
            </a>
                ...
                <div className="relative h-full bg-[#08080c] border border-fuchsia-500/30 group-hover:border-fuchsia-500/60 rounded-[2.5rem] p-6 sm:p-8 flex flex-col sm:flex-row items-center sm:items-start gap-6 transition-all z-10 text-center sm:text-left">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl sm:text-2xl font-black text-white mb-1">
                      {t.getApp?.downloadApk || "Direct APK"}
                    </h3>
                    ...
                    <p className="text-neutral-400 text-xs leading-relaxed">Download the official signed APK file directly from our secure CDN.</p>
                  </div>
                </div>
              </a>
            ) : (
          ...
          {olderApks.length > 0 && (
            <div className="mt-10 border-t border-white/5 pt-8">
              ...
              >
                {t.getApp?.olderVersions || "View Older Versions Archive"}
        ...
        <div className="w-full max-w-4xl bg-gradient-to-b from-[#0a0a0f]/90 to-[#050508]/90 backdrop-blur-2xl border border-white/10 rounded-[3rem] p-8 sm:p-12 shadow-[0_30px_60px_rgba(0,0,0,0.6)]">
          <div className="flex items-center gap-4 mb-8 border-b border-white/5 pb-6">
            ...
            <div>
              <h2 className="text-2xl sm:text-3xl font-black text-white tracking-tight">
                {t.getApp?.iosApp || "Apple iOS Installation"}
              </h2>
          ...
          <p className="text-sm text-neutral-300 mb-8 leading-relaxed max-w-3xl">
            {t.getApp?.iosPwaGuide || "Install as iOS Progressive Web App directly to your home screen."}
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
            ...
            <div className="bg-[#050508] border border-white/5 rounded-[2rem] p-6 text-center relative z-10 shadow-xl hover:-translate-y-2 transition-transform duration-300 group">
              ...
              <h3 className="text-base font-black text-white mb-2">1</h3>
              <p className="text-xs text-neutral-400 leading-relaxed mb-3">
                {t.getApp?.iosStep1 || "Open Safari and navigate to safiacademy.org"}
              </p>
            </div>
            ...
            <div className="bg-[#050508] border border-white/5 rounded-[2rem] p-6 text-center relative z-10 shadow-xl hover:-translate-y-2 transition-transform duration-300 group">
              ...
              <h3 className="text-base font-black text-white mb-2">2</h3>
              <p className="text-xs text-neutral-400 leading-relaxed mb-3">
                {t.getApp?.iosStep2 || "Tap the Share button in the toolbar"}
              </p>
            </div>
            ...
            <div className="bg-[#050508] border border-white/5 rounded-[2rem] p-6 text-center relative z-10 shadow-xl hover:-translate-y-2 transition-transform duration-300 group">
              ...
              <h3 className="text-base font-black text-white mb-2">3</h3>
              <p className="text-xs text-neutral-400 leading-relaxed mb-3">
                {t.getApp?.iosStep3 || "Scroll down and select 'Add to Home Screen'"}
              </p>
            </div>
          </div>
