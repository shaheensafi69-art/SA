      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full flex flex-col items-center">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 border-b border-white/10 pb-16">
          ...
          <div className="flex flex-col gap-5">
            ...
            {/* دکمه دانلود مستقیم فایل APK از پوشه public/app */}
            <a 
              href="/app/Safi Academy.apk"
              download="Safi Academy.apk"
              className="mt-2 flex items-center justify-center gap-3 w-full px-5 py-3.5 rounded-2xl bg-gradient-to-r from-yellow-400 to-amber-500 text-black font-extrabold text-xs uppercase tracking-widest hover:scale-105 hover:shadow-[0_0_25px_rgba(234,179,8,0.4)] transition-all duration-300 shadow-md"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
              Download Safi App (APK)
            </a>
          </div>
