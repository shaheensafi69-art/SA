        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 border-b border-white/10 pb-16">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3 mt-1 mb-2 flex-wrap">
              {/* X (Twitter) */}
              <a href="https://x.com/safi_academy" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-neutral-800 hover:border-transparent transition-all group" title="X (Twitter)">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/profile.php?id=61591973281742" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-[#1877F2] hover:border-transparent transition-all group" title="Facebook">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/safi-academy/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-[#0A66C2] hover:border-transparent transition-all group" title="LinkedIn">
              ...
              {/* WhatsApp */}
              <a href="https://whatsapp.com/channel/0029Vb8WCN9FXUucJwrltI32" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-[#25D366] hover:border-transparent transition-all group" title="WhatsApp">
              ...
              {/* Telegram */}
              <a href="https://t.me/safi_academy" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-[#229ED9] hover:border-transparent transition-all group" title="Telegram">
                <svg className="w-4 h-4 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.14.18-.357.295-.6.295-.002 0-.003 0-.005 0l.213-3.054 5.56-5.022c.24-.213-.054-.334-.373-.121l-6.869 4.326-2.96-.924c-.643-.204-.657-.643.136-.953l11.57-4.461c.535-.194 1.006.128.832.926z" /></svg>
              </a>
            </div>
