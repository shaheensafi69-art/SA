...
// ۲. لیست تاییدیه‌ها و مجوزهای ملی/دولتی
...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full border-t border-white/10 bg-[#020202] pt-20 pb-12 overflow-hidden font-sans z-10">

      {/* ================= BACKGROUND GLOWS & WATERMARK FLAG ================= */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-10 mix-blend-overlay"></div>
        <div className="bg-yellow-500/10 absolute top-1/4 left-1/4 h-72 w-72 rounded-full blur-[140px]" />
        <div className="bg-emerald-600/10 absolute right-1/4 bottom-1/4 h-96 w-96 rounded-full blur-[140px]" />

        {/* 🌟 واترمارک پرچم متحرک افغانستان در پس‌زمینه */}
        <div className="absolute inset-0 flex items-center justify-center opacity-[0.03] pointer-events-none select-none z-0 animate-pulse duration-1000">
          <div className="w-[800px] h-[500px] rounded-[100px] bg-gradient-to-r from-black via-red-600 to-emerald-600 blur-[120px] transform -rotate-12 scale-125"></div>
        </div>
      </div>

      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full flex flex-col items-center">

        {/* ================= SECTION 1: WHATSAPP COMMUNITY CARD ================= */}
        <div className="w-full bg-[#0a0a0f]/85 backdrop-blur-2xl border border-white/10 mb-20 rounded-[2.5rem] p-8 md:p-12 shadow-[0_20px_60px_rgba(0,0,0,0.8)] relative overflow-hidden group">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-500/20 via-transparent to-teal-500/20 rounded-[2.6rem] opacity-40 blur group-hover:opacity-75 transition duration-700 pointer-events-none"></div>

          <div className="relative z-10 grid items-center gap-8 md:grid-cols-2">
            <div>
              <span className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-[10px] font-black uppercase tracking-widest text-emerald-400 mb-4 shadow-inner">
                <Sparkles size={12} /> Official Community
              </span>
              <h3 className="mb-3 text-2xl font-black md:text-3xl text-white tracking-tight">
                Join Safi Academy WhatsApp Channel
              </h3>
              <p className="text-neutral-400 mb-6 text-sm md:text-base leading-relaxed text-justify">
                Connect with thousands of students, get instant scholarship alerts, live class updates, and exclusive educational materials directly on WhatsApp.
              </p>
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-gradient-to-r from-[#25D366] to-[#128C7E] hover:from-[#20ba5a] hover:to-[#0f766e] text-white shadow-[0_10px_25px_rgba(37,211,102,0.4)] rounded-2xl px-8 py-4 font-black text-xs uppercase tracking-widest transition-all hover:scale-105 active:scale-95"
              >
                <MessageCircle size={16} /> Join WhatsApp Channel Now
              </a>
            </div>

            <div className="hidden justify-end md:flex">
              <div className="relative group/img">
                <div className="bg-emerald-500/20 absolute inset-0 rotate-6 rounded-2xl blur-sm group-hover/img:rotate-12 transition-transform duration-500" />
                <img
                  src="https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=2070&auto=format&fit=crop"
                  alt="Safi Academy community"
                  className="relative w-80 h-56 rounded-2xl object-cover shadow-2xl border border-white/10"
                />
              </div>
            </div>
          </div>
        ...
        {/* ================= SECTION 2: GLOBAL PARTNERS MARQUEE ================= */}
        <div className="w-full border-b border-white/5 pb-16 mb-16 overflow-hidden flex flex-col items-center">
          <div className="flex flex-col items-center justify-center mb-8 px-4 text-center">
            ...
            <h4 className="text-sm md:text-base font-bold text-neutral-400 max-w-2xl leading-relaxed">
              Proudly partnered and integrated with world-leading technology, accreditation, and educational platforms.
            </h4>
          </div>
        ...
        <div className="flex flex-col items-center text-center mb-20 group cursor-default">
          ...
          <p className="text-neutral-400 max-w-2xl text-lg font-medium leading-relaxed text-justify">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 border-b border-white/10 pb-16">
          ...
          {/* Column 4: Connect & APK Download */}
          <div className="flex flex-col gap-5">
            <h3 className="text-white font-extrabold text-lg uppercase tracking-widest mb-2 flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-yellow-500"></span> Connect
            </h3>

            <div className="grid grid-cols-6 gap-2 mt-1 mb-2 w-full max-w-[280px]">
              {/* X (Twitter) */}
              <a href="https://x.com/safi_academy" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-neutral-800 hover:border-transparent transition-all group" title="X (Twitter)">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/profile.php?id=61591973281742" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-[#1877F2] hover:border-transparent transition-all group" title="Facebook">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/safi_academy01?igsh=MXV1ZW44aXBwOHd3NQ==" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-gradient-to-tr hover:from-[#f09433] hover:via-[#e6683c] hover:to-[#bc1888] hover:border-transparent transition-all group" title="Instagram">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/safi-academy/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-[#0A66C2] hover:border-transparent transition-all group" title="LinkedIn">
              ...
              {/* WhatsApp */}
              <a href="https://whatsapp.com/channel/0029Vb8WCN9FXUucJwrltI32" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-[#25D366] hover:border-transparent transition-all group" title="WhatsApp">
              ...
              {/* Telegram */}
              <a href="https://t.me/safi_academy" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-[#229ED9] hover:border-transparent transition-all group" title="Telegram">
            ...
            {/* ================= VIP GLOBAL ACADEMIC NODE & LIVE DESK ================= */}
            <div className="mt-1 relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.07] via-white/[0.02] to-transparent p-4 backdrop-blur-xl transition-all duration-500 hover:border-yellow-500/40 hover:shadow-[0_0_35px_rgba(234,179,8,0.15)] group">
              {/* Ambient Glowing Aura */}
              <div className="absolute -top-10 -right-10 w-28 h-28 bg-yellow-500/10 rounded-full blur-2xl group-hover:bg-yellow-500/20 transition-all duration-700 pointer-events-none" />
              <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-yellow-400/40 to-transparent"></div>
              ...
              <div className="flex items-center justify-between gap-2 mb-2.5">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[11px] font-extrabold text-neutral-200 tracking-wider uppercase">Live Campus Node</span>
                </div>
              ...
              {/* Tagline / Value */}
              <p className="text-[11.5px] text-neutral-400 leading-relaxed mb-3.5">
                Global institutional network with AI learning, live mentors & verified credentials.
              </p>

              {/* Action Button: Live Student Concierge */}
              <Link
                href={`/${currentLocale}/support`}
                className="relative group/btn flex items-center justify-between w-full px-3.5 py-2.5 rounded-xl bg-gradient-to-r from-yellow-500/10 via-amber-500/15 to-yellow-500/10 border border-yellow-500/30 hover:border-yellow-400 text-yellow-400 hover:text-black transition-all duration-300 overflow-hidden shadow-sm font-extrabold text-xs"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-yellow-400 via-amber-400 to-yellow-500 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                <div className="relative z-10 flex items-center gap-2">
                  <div className="w-5 h-5 rounded-md bg-yellow-500/20 text-yellow-400 group-hover/btn:bg-black/10 group-hover/btn:text-black flex items-center justify-center transition-colors">
                    <Sparkles className="w-3 h-3" />
                  </div>
                  <span className="tracking-wider uppercase text-[11px] group-hover/btn:text-black transition-colors">
                    Student Desk & AI
                  </span>
                </div>
                <ArrowRight className="relative z-10 w-3.5 h-3.5 text-yellow-400 group-hover/btn:text-black group-hover/btn:translate-x-1 transition-all" />
              </Link>
            </div>
          </div>
        ...
        {/* ================= SECTION 5: NATIONAL ACCREDITATIONS ================= */}
